...
public class Hierarchy
{
    ...
    public List<SootMethod> resolveConcreteDispatch(List<Type> classes, SootMethod m)
    {
        ...
        Iterator<Type> classesIt = classes.iterator();

        while (classesIt.hasNext()) {
            Type cls = classesIt.next();
        ...
        List<SootMethod> l = new ArrayList<SootMethod>(); l.addAll(s);
        return Collections.unmodifiableList(l);
    }
    ...
    public List<SootMethod> resolveAbstractDispatch(List<SootClass> classes, SootMethod m)
    {
        ...
        while (classesIt.hasNext())
            s.addAll(resolveAbstractDispatch(classesIt.next(), m));
